      ...
      <div className="flex items-center justify-between pb-6 border-b border-black/10 dark:border-white/10 mb-6">
        <div>
          ...
          <p className="text-xs text-[#64748B] dark:text-[#8E95A5] mt-1">
            Real-time updates when stylists mention you in looks, remix your pieces, or like your styling creations.
          </p>
        </div>
      ...
      <div className="flex gap-2 mb-6 overflow-x-auto no-scrollbar">
        {(['all', 'mentions', 'remixes', 'likes'] as const).map(tab => (
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-xs font-bold capitalize transition-all flex-shrink-0 ${
              filter === tab
              ...
              <div className="flex items-center gap-3.5 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-xs sm:text-sm text-[#0D0E12] dark:text-white leading-snug">
                    ...
                    {n.type === 'comment' && `commented on your look "${n.mixTitle}"`}
                  </p>
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                {n.targetMixId && (
                  <Link
                    ...
                    className="px-3.5 py-1.5 rounded-full text-xs font-semibold bg-[#F4F5F8] dark:bg-[#0D0E12] text-[#0D0E12] dark:text-[#E2FF66] border border-black/10 dark:border-[#E2FF66]/30 hover:bg-[#E2FF66] hover:text-[#0D0E12] flex items-center gap-1 transition-all"
                  >
                    <span>View Look</span>
                ...
                {n.targetPieceId && !n.targetMixId && (
                  <Link
                    ...
                    className="px-3.5 py-1.5 rounded-full text-xs font-semibold bg-[#E2FF66] text-[#0D0E12] flex items-center gap-1 hover:bg-[#d5f356] transition-all font-bold"
                  >
